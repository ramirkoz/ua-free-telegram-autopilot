...
def test_decide_spends_one_ai_call_only(monkeypatch):
    row = _row("Nvidia discloses a major new interconnect design", "Nvidia disclosed a new interconnect design for AI clusters. It doubles bandwidth to 800 Gbit/s while keeping power use unchanged. Engineers said production begins next quarter. " * 3)
    calls = []
