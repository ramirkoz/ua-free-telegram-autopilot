...
_DIRECT_DESCRIPTION = (
    ...
    "научпоп/техножурналістський пост без окремого заголовка. Текст складається з коротких речень і абзаців. "
    "Якщо є надійне релевантне медіа, текст має жорсткий ліміт 900 символів і додається максимум один медіафайл. Якщо медіа немає, публікується "
